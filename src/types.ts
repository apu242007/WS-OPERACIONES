...
export enum ViewState {
  ...
  FORM_ATS = 'FORM_ATS',
  DASHBOARD = 'DASHBOARD',
  FORM_INSPECTION_FREQUENCY = 'FORM_INSPECTION_FREQUENCY',
  FORM_FIRE_LOAD_CALC = 'FORM_FIRE_LOAD_CALC',
  FORM_NFPA_GUIDE = 'FORM_NFPA_GUIDE'
}
...
export interface ATSMetadata { numero: string; revision: string; fecha: string; sector: string; tarea: string; equipo?: string; elaboradoPor: string; funcionElab: string; revisadoPor: string; funcionRev: string; aprobadoPor: string; funcionApro: string; }
